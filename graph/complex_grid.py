...
NODES: Dict[str, Node] = {
    ...
    'N21': Node(50, 100), 'N22': Node(100, 100), 'N23': Node(150, 100), 'N24': Node(200, 100), 'N25': Node(250, 100), 'N27': Node(350, 100), 'N28': Node(400, 100), 'N29': Node(450, 100),
    ...
    'N51': Node(50, 250), 'N52': Node(100, 250), 'N53': Node(150, 250), 'N54': Node(200, 250), 'N56': Node(300, 250), 'N57': Node(350, 250), 'N58': Node(400, 250), 'N59': Node(450, 250),
...
EDGES: List[Edge] = [
    ...
    Edge(NODES['N21'], NODES['N22']), Edge(NODES['N22'], NODES['N23']), Edge(NODES['N23'], NODES['N24']), Edge(NODES['N24'], NODES['N25']), Edge(NODES['N27'], NODES['N28']), Edge(NODES['N28'], NODES['N29']),
    ...
    Edge(NODES['N51'], NODES['N52']), Edge(NODES['N52'], NODES['N53']), Edge(NODES['N53'], NODES['N54']), Edge(NODES['N56'], NODES['N57']), Edge(NODES['N57'], NODES['N58']), Edge(NODES['N58'], NODES['N59']),
    ...
    Edge(NODES['N11'], NODES['N21']), Edge(NODES['N12'], NODES['N22']), Edge(NODES['N13'], NODES['N23']), Edge(NODES['N14'], NODES['N24']), Edge(NODES['N15'], NODES['N25']), Edge(NODES['N17'], NODES['N27']), Edge(NODES['N18'], NODES['N28']), Edge(NODES['N19'], NODES['N29']),
    Edge(NODES['N25'], NODES['N35']), Edge(NODES['N27'], NODES['N37']), Edge(NODES['N28'], NODES['N38']), Edge(NODES['N29'], NODES['N39']),
    ...
    Edge(NODES['N41'], NODES['N51']), Edge(NODES['N42'], NODES['N52']), Edge(NODES['N43'], NODES['N53']), Edge(NODES['N44'], NODES['N54']), Edge(NODES['N46'], NODES['N56']), Edge(NODES['N47'], NODES['N57']), Edge(NODES['N48'], NODES['N58']), Edge(NODES['N49'], NODES['N59']),
    Edge(NODES['N51'], NODES['N61']), Edge(NODES['N52'], NODES['N62']), Edge(NODES['N53'], NODES['N63']), Edge(NODES['N54'], NODES['N64']), Edge(NODES['N56'], NODES['N66']), Edge(NODES['N57'], NODES['N67']), Edge(NODES['N58'], NODES['N68']), Edge(NODES['N59'], NODES['N69']),
    Edge(NODES['N61'], NODES['N71']), Edge(NODES['N63'], NODES['N73']), Edge(NODES['N64'], NODES['N74']), Edge(NODES['N65'], NODES['N75']), Edge(NODES['N66'], NODES['N76']), Edge(NODES['N67'], NODES['N77']), Edge(NODES['N68'], NODES['N78']), Edge(NODES['N69'], NODES['N79']),
    ...
    Edge(NODES['N81'], NODES['N91']), Edge(NODES['N82'], NODES['N92']),
]
